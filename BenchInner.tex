...
\end{hypothesis}
A necessary condition is that one has a large benchmark set, ideally in the thousands. Sampling uniformly is always a question of judgement.
\begin{figure}[h]
\caption{A Survivor Plot\label{fig:survivor}}
\includegraphics{log-accumulated2.pdf}
\vskip-0pt
\end{figure}
\section{``Cactus'' or ``Survivor'' plots}
